...
public class RestuarantManagement extends javax.swing.JFrame {
    ...
    //auto generated code by netbeans when the desgin frames are created which include table creation, variable declarerations and more
    ...
    private void loginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginBtnActionPerformed
        ...
        //executes the database connection
        try{
            Class.forName("com.mysql.jdbc.Driver");
            Connection conn= DriverManager.getConnection("jdbc:mysql://localhost:3306/logininfo?", "root", "");
            Statement stmt = conn.createStatement();
            //result set query equal to the database call to select an item from the table that macthes the username and password
            ResultSet rs=stmt.executeQuery("Select * from userdetail where username='"+user+"' and password='"+pass+"'");
            //if the result set produces something then we have a matching username and password
            if (rs.next()){
